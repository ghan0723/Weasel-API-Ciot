...
class OutlookService {
        ...
        return new Promise((resolve, reject) => {
            ...
            Promise.all([
                ...
                resolve({
                    ...
                    beforeoutlooks: (this.query2 !== 0) ? (((this.query1 - this.query2) / this.query2) * 100).toFixed(2) : (this.query1 / 1 * 100).toFixed(2),
                });
            })
                .catch((error) => {
                reject(error);
    ...
    getApiData() {
        return new Promise((resolve, reject) => {
            const query = 'select `time` as Time, pcname , agent_ip , process, media_type , file as Files , ' +
