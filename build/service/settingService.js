...
class SettingService {
    ...
    getAgentSetting() {
        const query = "select uid, svr_checkbox_flag, clnt_svr_ip, clnt_svr_port, clnt_svr_conn_interval, clnt_license, clnt_exceptions_list, svr_patterns_list, svr_port, svr_file_retention_periods, svr_auto_fileupload from serversetting";
        return new Promise((resolve, reject) => {
            db_1.default.query(query, (error, result) => {
                ...
                if (error) {
                    ...
                    const clntKeywordList = (_b = (_a = result[0]) === null || _a === void 0 ? void 0 : _a.svr_patterns_list) !== null && _b !== void 0 ? _b : '';
                            ...
                            resolve([
                                {
                                    ...
                                    clnt_exceptions_list: modifiedExcepIP,
                                    svr_patterns_list: (_5 = result[0]) === null || _5 === void 0 ? void 0 : _5.svr_patterns_list,
                            ...
                            resolve([
                                {
                                    ...
                                    svr_patterns_list: (_16 = result[0]) === null || _16 === void 0 ? void 0 : _16.svr_patterns_list,
