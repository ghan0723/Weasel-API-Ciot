...
router.get("/dashboard", (req, res) => {
    ...
    log_1.weasel.log(username, req.socket.remoteAddress, `[Info] The user '${username}' accesses the Dashboard menu.`);
...
router.get("/tables", (req, res) => {
    ...
    log_1.weasel.log(username, req.socket.remoteAddress, `[Info] The user '${username}' accesses the Leak Detection History menu.`);
...
router.get("/leaked", (req, res) => {
    ...
    userService.getPrivilege(username)
        ...
        if (result[0].privilege === 3) {
            ...
            log_1.weasel.log(username, req.socket.remoteAddress, `[Info] The user '${username}' accesses the Watchlist menu.`);
...
router.get("/analysis", (req, res) => {
    ...
    log_1.weasel.log(username, req.socket.remoteAddress, `[Info] The user '${username}' accesses the Analytics menu.`);
...
router.get("/userList", (req, res) => {
    ...
    if (typeof username !== "string") {
        ...
        log_1.weasel.log(username, req.socket.remoteAddress, `[Info] The user '${username}' accesses the User Management menu.`);
