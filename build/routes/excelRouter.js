...
router.get("/dwn", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        log_1.weasel.error(username, req.socket.remoteAddress, `[ERROR] [ExcelService] - User '${username}' The download of the excel file in ${contents} failed.`);
...
router.post("/analytics", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        log_1.weasel.error(username, req.socket.remoteAddress, `[ERROR] [ExcelService] - User '${username}'  - User '${username}' Downloading the analysis excel file failed.`);
