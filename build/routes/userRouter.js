                            ...
                            userService
                                ...
                                if (passwd !== decPasswd) {
                                    userService
                                        ...
                                        .then((enabled) => {
                                        log_1.weasel.log(username, req.socket.remoteAddress, "Password do not match.");
                                        log_1.weasel.log(username, req.socket.remoteAddress, "아이디와 비밀번호가 맞지 않습니다.");
                                        res.status(401).json({
                                            error: "비밀번호가 일치하지 않습니다",
                                            redirectUrl: `${ipDomain_1.frontIP}/auth/sign-in`,
                                        });
                ...
                if (result1[0].privilege !== 1) {
                    ...
                    userService
                        ...
                        if (result3.inRange) {
                            ...
                            log_1.weasel.error(user.cookie, req.socket.remoteAddress, "Failed to update user by incorrect IP range ");
