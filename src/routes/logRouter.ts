...
router.get("/dashboard", (req: Request, res: Response) => {
  ...
  weasel.log(
    ...
    `[Info] The user '${username}' accesses the Dashboard menu.`
  );
...
router.get("/tables", (req: Request, res: Response) => {
  ...
  weasel.log(username,req.socket.remoteAddress,`[Info] The user '${username}' accesses the Leak Detection History menu.`);
...
router.get("/leaked", (req: Request, res: Response) => {
  ...
  .then((result) => {
    if(result[0].privilege === 3){
      ...
      weasel.log(username,req.socket.remoteAddress,`[Info] The user '${username}' accesses the Watchlist menu.`);
...
router.get("/analysis", (req: Request, res: Response) => {
  ...
  weasel.log(username,req.socket.remoteAddress,`[Info] The user '${username}' accesses the Analytics menu.`);
...
router.get("/userList", (req:Request, res:Response) => {
  ...
  if (typeof username !== "string" ) {
    ...
    weasel.log(username, req.socket.remoteAddress, `[Info] The user '${username}' accesses the User Management menu.`);
