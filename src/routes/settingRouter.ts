...
router.post("/server", (req: Request, res: Response) => {
  ...
  .then((result) => {
    ...
    .catch(() => {
      ...
      weasel.error(username, req.socket.remoteAddress, 'An error occurred while executing a query that changes server settings to the database.');
...
router.get("/servers", (req: Request, res: Response) => {
  ...
  settingService
    ...
    .then((result) => {
      ...
      weasel.log(username, req.socket.remoteAddress, "View server settings information ");
...
router.post("/agent", (req: Request, res: Response) => {
  ...
  settingService
    ...
    .catch(() => {
      weasel.error(username, req.socket.remoteAddress, "An error occurred while executing a query to change agent settings to the database.");
  ...
  settingService
    ...
    .then((result) => {
      settingService
        .getUpdateFileAgent()
        .then((result2) => {
          weasel.log(username, req.socket.remoteAddress, "View agent settings information ");
